        ...
        StringRequest request = new StringRequest(Request.Method.POST, Constant.DETAIL_LOMBA, response -> {
            ...
            try {
                ...
                if (status_code == 200 && message.equals("Success")) {
                    ...
                    jenis.setText(detailLomba.getJSONArray("pelaksanaan_lomba").getJSONObject(0).optString("info"));
                    status.setText(detailLomba.getJSONArray("pelaksanaan_lomba").getJSONObject(0).optString("status"));
                    deskripsi.setText(detailLomba.getJSONArray("detail_lomba").getJSONObject(0).optString("detail_lomba"));
                    tgl_mulai.setText(formatDate(detailLomba.getJSONArray("pelaksanaan_lomba").getJSONObject(0).optString("tanggal_mulai")));
                    tgl_selesai.setText(formatDate(detailLomba.getJSONArray("pelaksanaan_lomba").getJSONObject(0).optString("tanggal_selesai")));
